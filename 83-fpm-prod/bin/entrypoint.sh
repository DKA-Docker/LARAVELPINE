...
# =============================================================================
# DKA Laravel Entrypoint — 83-fpm-prod (Nginx + PHP-FPM production)
# =============================================================================
...
echo "╔══════════════════════════════════════════════════╗"
log  " Mode  : Nginx + PHP-FPM [production]  |  RAM: $MEM_USAGE"
echo "╚══════════════════════════════════════════════════╝"
...
# Trap sebelum start agar SIGTERM saat startup juga tertangani
...
# wait -n: event-driven, tanpa polling. Jika nginx atau fpm mati → exit → Docker restart.
